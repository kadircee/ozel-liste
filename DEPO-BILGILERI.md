...
**Diğer ("kesinlikle istemiyorum" / kişisel tercih):** Filmmirasım, SeiCode, YTS, YeniKaynak, YesilCamTv, MirrorVerse, Vavoo, WebDramaTurkey, Syncler, Torrential, BelgeselX, CizgiMax, CizgiveDizi, DiziBox, DiziPal, KultFilmler, Dizilla
...
**Site açılmıyordu (site düzelirse geri denenebilir):** Dizipod, DiziFilmORG, DiziPalOrijinal, DiziYo, FilmBOL, FullHDFilm, AltiYuzAltmisAltiFilmIzle, SetFilmIzle
...
**Kaynak kapanması (cs-kraptor `.cs3` dosyaları 404):** Dizigecesi, DiziLife, DiziMom, FilmEkseni, FilmHane, Filmzal, HDFilmDelisi, HDFilmizle, KraptorPlus, RareFilmm, SelcukFlix, SineWix, Sinezy, Turkdizileri, TvDiziler, WFilmizle, YabanciDizi
